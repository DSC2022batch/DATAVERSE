...
const Landing = () => {
  return (
    <div className="bg-black ">
      ...
      <div className="__hero flex items-center justify-between min-h-[100dvh] w-full overflow-hidden">
        <div className="flex flex-col w-full h-full md:py-36 lg:py-0 justify-center items-center gap-14">
          ...
          <button className="overflow-hidden hover:scale-95 duration-200 hover:text-rose-900 font-bold bg-rose-900 explore__button saturate-200 px-4 py-2 text-white font-DECTM text-2xl">Explore the Event</button>
        </div>
      </div>
